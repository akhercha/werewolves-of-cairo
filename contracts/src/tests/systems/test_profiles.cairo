...
//                                 Utilities
// *************************************************************************
fn setup() -> (ContractAddress, IWorldDispatcher, IProfilesDispatcher) {
    ...
    let profiles_system = IProfilesDispatcher { contract_address };

    return (caller_address, world, profiles_system);
}
